...
var HTMLlinkdin = '<li class="flex-item"><span class="orange-text">Linkdin</span><span class="white-text">%data%</span></li>';
...
var HTMLschoolMajor = '<p class="major"><em><br>Major: %data%</em></p>';
